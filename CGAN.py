...
def sample_image(n_row, batches_done):
    ...
    save_image(gen_imgs.numpy(), "./result/%d.png" % batches_done, nrow=n_row)
...
for epoch in range(opt.n_epochs):
    ...
    if epoch % 10 == 0:
        generator.save("./model/generator_{}.pkl".format(epoch))
        discriminator.save("./model/discriminator_{}.pkl".format(epoch))
